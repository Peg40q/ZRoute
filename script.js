...
function buildGuides() {
    const guides = [
        {title: "📡 Фаза 1: Радар — полное руководство", content: `<h4>Описание</h4><p>Очки за задания радара, выносливость, опыт героя, сбор ресурсов, боевые чипы/части бойца.</p><h4>Подготовка за день</h4><ul><li>Накопите 30–35 заданий (не трогайте 18 часов).</li><li>Держите полную выносливость + банки.</li><li>Отправьте отряды на сбор до старта фазы (05:00 МСК).</li></ul><h4>Старт</h4><ul><li>Выполните накопленные задания, используйте выносливость, части бойцов.</li><li>Постоянно отправляйте отряды на сбор.</li><li>Совмещайте с «Готовностью к миссии».</li></ul>`},
        {title: "🏗️ Фаза 2: Строительство — призрачная стройка", content: `<h4>Подготовка</h4><ul><li>Начните улучшать здания за несколько дней до фазы, чтобы они завершились после её старта («призрачная стройка»).</li><li>Не тратьте ускорения постройки всю неделю.</li></ul><h4>Старт</h4><ul><li>Завершите стройки → очки за мощь.</li><li>Запросите Министра строительства.</li><li>Используйте ускорения, выполните оранжевую миссию, отправьте легендарный транспортник.</li></ul>`},
        {title: "🔬 Фаза 3: Технологии — экономия и вливание", content: `<h4>Главная стратегия</h4><p>Копите ускорения исследований и научные данные всю неделю, вливайте строго в среду.</p><h4>План</h4><ul><li>Закройте радар, используйте ускорения, завершите долгие исследования.</li><li>Тратьте научные данные, открывайте сундуки с компонентами.</li><li>Запросите Министра науки.</li></ul>`},
        {title: "🦸 Фаза 4: Герой — полное руководство", content: `<h4>Подготовка</h4><ul><li>Копите опыт героя, карты найма, фрагменты, книги навыков.</li></ul><h4>Старт</h4><ul><li>Сначала карты найма → опыт героя → фрагменты (мифические → эпические → редкие) → книги навыков.</li><li>Совмещайте с «Готовностью к миссии».</li></ul>`},
        {title: "⚔️ Фаза 5: Боеготовность — совмещение ускорений", content: `<h4>Действия</h4><ul><li>Используйте ускорения постройки, исследований, тренировок.</li><li>Обучайте солдат в указанные интервалы (очки сразу).</li><li>Используйте переобучение (Т6→Т8) для экономии ускорений.</li></ul>`},
        {title: "🏆 Фаза 6: Рейд — безопасная война", content: `<h4>Подготовка</h4><ul><li>Купите щит, отключите оборону в гарнизоне.</li><li>Ресурсы держите в инвентаре, освободите госпиталь.</li></ul><h4>Во время рейда</h4><ul><li>Разведывайте цели, атакуйте, не обнуляйте базы без сопротивления.</li><li>Следите за HP базы, не телепортируйтесь в лагерь во время боя.</li></ul>`},
        {title: "🎯 Готовность к миссии: 18 сундуков без затрат", content: `<h4>Три события</h4><h4>1. Обучение солдат</h4><ul><li>Должность Министра обороны, перед событием лагеря пусты.</li><li>Тренируйте Т6, затем улучшайте до Т8 (дешевле).</li></ul><h4>2. Улучшение бойца</h4><ul><li>Тратьте энергию (~300 ед.), используйте бесплатное восстановление 2 раза.</li></ul><h4>3. Улучшение героя</h4><ul><li>Тратьте накопленный опыт и книги.</li></ul><p>Стройку и науку не трогайте — оставьте ускорения для Битвы Альянсов.</p>`},
        {title: "📊 Аналитика событий (на основе данных сервера)", content: `<h4>Основные выводы</h4><ul><li>Главная сила сервера — активность в Состязании альянсов (VS) и массовость топ-игроков.</li><li>Слабые места: суммарный урон по Гигантскому боссу и активность в «Готовности к миссии».</li><li>Тактика: организовывать массовые атаки босса («зерг-раш»), контролировать грабежи транспортников (бить только целые фуры).</li><li>Для победы в войне серверов важна не столько сила отдельных китов, сколько скоординированность всех игроков.</li></ul><p>Используйте аналитику для планирования: уделяйте внимание боссу, не пропускайте сундуки готовности, контролируйте грабежи.</p>`}
    ];
